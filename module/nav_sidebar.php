<ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion toggled" id="accordionSidebar">
    ...
    <?php if($_SESSION['reg_type'] == 'host'){ ?>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAdminMenu"
               aria-expanded="true" aria-controls="collapseSocialMedia">
                <i class="fas fa-fw fa-user-lock"></i>
                <span>Host</span>
            </a>
            <div id="collapseAdminMenu" class="collapse" aria-labelledby="headingcollapseAdminMenu"
    ...
    <!-- Nav Item - AniDB -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDatabaseSeasonal"
           aria-expanded="true" aria-controls="collapseDatabaseSeasonal">
            <i class="fas fa-fw fa-database"></i>
            <span>View</span></a>
        </a>
        <div id="collapseDatabaseSeasonal" class="collapse" aria-labelledby="headingDatabaseSeasonal"
             data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
