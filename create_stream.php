                            ...
                            <div class="card-body table-responsive">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="name" type="text" id="inputFullName" class="form-control"
                                            required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="radio" id="free" name="type"
                                               value="free" <?php if (strtolower($_SESSION['type'] ?? '') == 'free') echo 'checked'; ?>>
                                        <label for="free">Free</label><br>
                                        <input type="radio" id="paid" name="type"
                                               value="paid" <?php if (strtolower($_SESSION['type'] ?? '') == 'paid') echo 'checked'; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="link" type="url" id="inputlink"
                                               class="form-control"
                                               pattern="[^\s]+">
                                    </div>
